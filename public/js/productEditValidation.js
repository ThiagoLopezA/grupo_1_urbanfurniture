window.addEventListener("load", () => {
  ...
  // Etiqueta de error
  let errorName = document.querySelector(".text-danger--edit.name");
  let errorPrecio = document.querySelector(".text-danger--edit.price");
  let errorDiscount = document.querySelector(".text-danger--edit.discount");
  let errorDescription = document.querySelector(
    ".text-danger--edit.description"
  );
  let errorCategories = document.querySelector(".text-danger--edit.categories");
